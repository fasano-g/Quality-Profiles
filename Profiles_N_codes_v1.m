...
%        test problem 'p', then provide a very large value in the 
%        corresponding (p,s) position of the matrix
%
...
%        number of precision level considered by the use (namely the 
%        entries of the vector 'tau'). The entry (p,s,t) of FF represents 
%        the number of function evaluations necessary to the solver 's' 
%        to find a solution of the test problem 'p', within the precision 
%        level 't'. In case the solver 's' has a failure on the test 
%        problem 'p', when using the precision level 't', then (p,s,t)
%        must be equal to 'any negative number'
%
%  tau = represents the precision level(s) associated to the required 
%        data profile(s). It can either be a value in (0,1], or a vector 
%        (but with an even number of entries), being each entry in (0,1]
%
...
% the number of variablef of the test problem 'p'
% -----------------------------------------------------------------------
% NV = [];
 NV = [ 2
        2
...
% -----------------------------------------------------------------
% Matrix used to plot Quality Profiles. TT whose columns are (respectively): 
...
% This data will be uniquely used to plot Quality Profiles, and will be 
% ignored if Performance Profiles or Data Profiles are sought
% -----------------------------------------------------------------
% TT = [];
 TT = [(-1 + 2*rand(100,1)) ...
...
% and the value of the objective function at the first iterate, 
